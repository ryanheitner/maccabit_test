...
mixin _$DetailsState {
  ...
  List<ProductItemView> get products => throw _privateConstructorUsedError;
...
abstract class $DetailsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, List<ProductItemView> products});
}
...
class _$_DetailsState implements _DetailsState {
  const _$_DetailsState(
      {this.isLoading = true, final List<ProductItemView> products = const []})
      : _products = products;

  @override
  @JsonKey()
  final bool isLoading;
  final List<ProductItemView> _products;
  @override
  @JsonKey()
  List<ProductItemView> get products {
  ...
  @override
  String toString() {
    return 'DetailsState(isLoading: $isLoading, products: $products)';
  }
...
abstract class _DetailsState implements DetailsState {
  const factory _DetailsState(
      {final bool isLoading,
      final List<ProductItemView> products}) = _$_DetailsState;
